...
- previous integrated E1 prediction SHA256:
...
3. **Thresholds are frozen from existing provenance, not newly re-derived for
   D.**
4. **Upstream artifacts left as-is** (intentional): stale
