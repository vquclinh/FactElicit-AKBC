...
def test_exactly_three_modes_exist() -> None:
    """The vocabulary, stated once. A fourth needs a deliberate edit here.

    A fourth briefly existed - `direct_uncalibrated`, for the heterogeneous
    portfolio experiment - and was retired with it (Audit 0066).
    """
